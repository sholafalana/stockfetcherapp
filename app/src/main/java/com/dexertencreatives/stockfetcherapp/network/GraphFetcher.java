...
import com.dexertencreatives.stockfetcherapp.Graphs.BarGraphHandler;
import com.dexertencreatives.stockfetcherapp.UI.GraphActivity;
import com.dexertencreatives.stockfetcherapp.Graphs.GraphStockHelper;
import com.dexertencreatives.stockfetcherapp.Graphs.LineGraphHandler;
import com.dexertencreatives.stockfetcherapp.adapter.CustomFragmentAdapter;
import com.dexertencreatives.stockfetcherapp.model.GraphStockData;
...
public class GraphFetcher extends AsyncTask<String, Void, GraphStockData> {
    ...
    String alphaAPIKey = "EMEO1QQ89KIQCDGS";
    ...
    protected GraphStockData doInBackground(String... params) {
        ...
        try {
            ...
            URL sourceUrl = new URL("https://www.alphavantage.co/query?function=" + timeFunction + "&interval=" + rng + "&outputsize=full&apikey=" + alphaAPIKey + "&datatype=csv&symbol=" + sym);
